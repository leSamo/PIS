...
describe('Director (admin) functionality', function() {
  ...
  it('Login as admin', function() { 
    ...
    it('Create and delete event', function() {   
      ...
      cy.get('#pf-modal-part-5 > .pf-c-form > .pf-c-form__group > .pf-c-form__group-control > #event-name').type('Test event')
   ...
   it('Create and delete user', function() {
    ...
    cy.get('.pf-c-form > .pf-c-form__group > .pf-c-form__group-control > .pf-c-select > #pf-select-toggle-id-66').click()
